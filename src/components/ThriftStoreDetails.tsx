...
const ThriftStoreDetails = () => {
    ...
    return (
      <>
        <div className="container mx-auto px-4 py-16 text-center">
          ...
          <p className="mb-6">
            The store you are looking for doesn't exist or has been removed.
          </p>
  ...
  return (
    <div className="min-h-screen bg-[#F4E3B2]">
      <Navbar />
      <div className="pt-10 lg:pt-[100px] pb-8 px-6  ">
        {/* Store Header */}
        <div className="bg-[#F4E3B2] py-8">
          <div className="container mx-auto px-4">
            <Link
              to="/thrift/thrift-stores"
              className="items-center text-sm text-thrift-600 hover:text-thrift-700 mb-4 flex justify-end underline "
            >
            ...
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="md:w-2/3">
                <div className="flex items-center mb-2">
                  <h1 className="text-3xl font-bold text-thrift-800 mr-3">
                    {store.name}
                  </h1>
                  {store.isVerified && (
                    <Badge className="bg-thrift-600 text-rose-900 flex items-center gap-1">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                  ...
                  <div className="flex items-center p-3 bg-white rounded-lg shadow-sm">
                    ...
                    <div>
                      ...
                      <a
                        href="#"
                        className="text-sm font-medium text-thrift-600 hover:underline"
                      >
                        Visit website
                      </a>
                    </div>
                ...
                <div className="flex flex-wrap gap-2">
                  <Button className="bg-rose-900 hover:bg-thrift-700 text-white">
                    Contact Store
                  </Button>
                  <Button
                    variant="outline"
                    className="border-thrift-600 text-thrift-600"
                  >
                    Save to Favorites
                  </Button>
                </div>
