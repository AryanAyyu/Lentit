        ...
        <Card className="overflow-hidden">
          <div className="flex flex-col md:grid md:grid-cols-2 gap-0">
            ...
            <div className="relative aspect-[4/3] md:aspect-[5/3]">
              ...
              />
              <Badge className="absolute top-2 right-4 bg-rose-900 text-white">
                <h1 className="h-4 w-2 mr-1" /> 30% OFF
              </Badge>
            </div>
            ...
            <CardContent className="p-4 md:p-8">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4">
                ...
                <div className="flex items-center gap-2 justify-center">
                  <Timer className="h-5 w-4 md:h-5 md:w-5 mb-3 text-thrift-600" />
                  <div className="flex gap-1  md:gap-2">
                    {Object.entries(timeLeft).map(([unit, value]) => (
                      <div key={unit} className="flex flex-col items-center">
                        ...
                        <span className="text-xs text-foreground/70 mt-1 capitalize">
                          {unit}
                        </span>
                      </div>
                    ))}
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-3 mt-4 lg:mt-12">
                {dealProduct.name}
              </h3>
              <p className="text-sm md:text-base text-gray-600 mb-4">
                Exclusive daily deal on this premium thrifted item. Grab it
                before it's gone!
              </p>

              <div className="space-y-4">
                <div className="flex justify-center gap-3 md:gap-4 lg:mt-10 mb-2">
                ...
                <Link to={`/thrift/productthrift/${dealProduct.id}`}>
                  <Button className="w-60 bg-rose-900 hover:bg-rose-900 text-white py-2 md:py-2.5 lg:mt-10">
                    Shop Now
                  </Button>
                </Link>
              </div>
