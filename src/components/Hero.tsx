          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-white p-6">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <button className="bg-[#74070E] text-[#F4E3B2] font-medium py-3 px-8 rounded-lg transition-all duration-300 animate-fade-in hover:shadow-lg" style={{ animationDelay: "0.4s" }}>
                  Shop Now
                </button>
              </div>
            </div>
