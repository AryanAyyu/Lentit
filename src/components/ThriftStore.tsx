...
import { Search, CheckCircle2, MapPin, Store, ArrowLeft } from "lucide-react";
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="pt-10 lg:pt-[100px] pb-8 px-6 bg-[#F4E3B2]">
        ...
        <div className="bg-accent1-light py-5">
          <div className="container mx-auto px-2 flex flex-col justify-center">
            ...
            <p className="md:text-lg text-thrift-600">
              Explore curated collections from established thrift stores. Each
              store offers unique items and styles.
            </p>
          </div>
        </div>
