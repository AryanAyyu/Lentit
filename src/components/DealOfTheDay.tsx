        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 items-center  justify-evenly">
          <div ref={dealRef} className="reveal-on-scroll order-2 lg:order-1 sm:ml-20 ">
            <div className="flex items-center gap-1 mb-3 md:mb-4">
              <span className="bg-[#F4E3B2] text-rose-900 text-xs sm:text-sm font-medium px-2 sm:px-3 py-0 rounded-full">Limited Time</span>
              <span className="text-foreground/70 text-sm sm:text-base ">Deal ends soon</span>
            </div>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-rose-900 mb-1 md:mb-4 lg:mr-80">Deal of the Day</h2>
            <h3 className="text-xl sm:text-2xl font-semibold mb-2 lg:mr-80">Designer Evening Gown</h3>
            <p className="text-lg sm:text-xl text-rose-800 font-medium mb-1 lg:mr-80">
              ₹2000 <span className="text-foreground/70 text-sm sm:text-base line-through ml-2">₹2500</span>
            </p>
            <p className="text-foreground/70 text-sm sm:text-base mb-3 md:mb-8 max-w-md">
              This stunning designer evening gown is perfect for special occasions. Rent it now for a fraction of the retail price!
            </p>
            
            <div className="flex gap-4 sm:gap-6 mb-3 md:mb-8 justify-center lg:mr-80">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4  lg:ml-20">
          ...
          <div className="order-1 lg:order-2 reveal-on-scroll " style={{ transitionDelay: "200ms" }}>
            <div className="rounded-xl overflow-hidden relative sm:w-1/2 sm:ml-20">
              <img 
                ...
                alt="Deal of the Day" 
                className="w-full h-auto object-cover aspect-[9/4] sm:aspect-[4/3] w-8/10 "
              />
