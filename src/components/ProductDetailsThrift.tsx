...
const ProductDetailsThrift = () => {
  ...
  return (
    <div className="min-h-screen">
      <Navbar />
      <div className="pt-10 lg:pt-[100px] pb-8 px-6 bg-[#F4E3B2] ">
        <div className="container mx-auto px-4 py-8 text-sm">
          <Link to="/thrift" className=" flex justify-end underline">
            <ArrowLeft className="flex h-6 w-4" /> Back to Products
          </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                {productImages.map((image, index) => (
                  <button
                    ...
                    className={`w-16 h-16 border-2 rounded-md overflow-hidden ${
                      index === 0 ? "border-thrift-500" : "border-gray-200"
                    }`}
                  >
                    <img
                      src={image}
            ...
            <div>
              <div className="mb-6">
                <Badge className="mb-2 bg-accent1 text-rose-900">
                ...
                <div className="flex items-center mb-4">
                  <div className="flex text-rose-900 mr-2">
                    {[...Array(5)].map((_, i) => (
                      <Star
                        key={i}
                        className={`w-4 h-4 ${i < 4 ? "fill-red-900" : ""}`}
                      />
                    ))}
                  </div>
                ...
                <p className="text-gray-700 mb-6">
                  {product.description ||
                    "This vintage item has been carefully selected for its quality and unique style. Perfect for adding character to your wardrobe."}
                </p>

                <div className="grid md:grid-cols-4 grid-cols-2 gap-1 mb-6">
                  ...
                  <div className="p-3 bg-gray-50 rounded-lg">
                    ...
                    <p className="text-sm">{product.condition || "Good"}</p>
                  </div>
                  <div className="p-3 bg-gray-50 rounded-lg">
                    <p className="text-xs font-medium">Brand</p>
                    <p className="text-sm">{product.brand || "Unknown"}</p>
                  </div>
                  <div className="p-3 bg-gray-50 rounded-lg">
              ...
              <div className="flex gap-4 mb-8">
                <Button className="flex-grow bg-thrift-600 hover:bg-thrift-700 text-white bg-rose-900">
                ...
                <Button
                  ...
                  size="icon"
                >
                  <Share2 className="h-5 w-5 text-rose-900" />
                </Button>
              </div>

              <div className="space-y-3 flex flex-row items-center">
                <div>
                  <div className="flex flex-col md:flex-row md:hidden gap-y-7 md:gap-y-5">
                ...
                <div className="flex flex-col md:flex-row">
                  ...
                  <div>
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Supporting sustainable fashion in your community
                      </p>
                    </div>
                  </div>
                </div>
